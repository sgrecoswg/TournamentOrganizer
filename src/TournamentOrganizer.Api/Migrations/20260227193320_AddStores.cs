        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stores_Licenses_LicenseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StoreId = table.Column<int>(type: "int", nullable: false),
                    AllowableTradeDifferential = table.Column<decimal>(type: "decimal(5,2)", precision: 5, scale: 2, nullable: false, defaultValue: 10m),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Licenses_StoreId",
                table: "Licenses",
                column: "StoreId");

            migrationBuilder.CreateIndex(
                name: "IX_Stores_LicenseId",
                table: "Stores",
                column: "LicenseId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Licenses_Stores_StoreId",
                table: "Licenses",
                column: "StoreId",
                principalTable: "Stores",
                principalColumn: "Id",
