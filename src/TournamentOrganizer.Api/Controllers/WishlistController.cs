...
[ApiController]
[Route("api/players/{playerId}/wishlist")]
public class WishlistController : ControllerBase
{
    ...
    [HttpGet]
    public async Task<ActionResult<List<WishlistEntryDto>>> GetAll(int playerId)
        => Ok(await _service.GetByPlayerAsync(playerId));

    [HttpGet("supply")]
    public async Task<ActionResult<List<WishlistCardSupplyDto>>> GetSupply(int playerId)
